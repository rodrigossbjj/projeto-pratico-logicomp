...
def salva_comparacao(puzzle_name, puzzle_text, llm_answer, z3_answer, match):
    ...
    txt_path = os.path.join(resultados_dir, "comparacoes_gemini.txt")
...
if match:
    print(f"\n✅ O resultado da IA(GEMINI) COINCIDE com o resultado do Z3!")
else:
    print(f"\n❌ A IA(GEMINI) ERROU! Veja detalhes salvos em resultados/results.jsonl")
